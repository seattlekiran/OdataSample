...
namespace ODataClient
{
    ...
    class Program
    {
        ...
        private static void Test()
        {
            ...
            //var s = new Supplier();
            //s.ID = 11;
            //s.Name = "Test Company " + s.ID;
            //s.Country = "USA, China";
            //ctx.AddToSuppliers(s);
            //ctx.SaveChanges();

            //foreach (var supplier in ctx.Suppliers)
            //{
            //    Console.WriteLine(supplier.Country);
        ...
        private static void Get_ProductFamily_Supplier()
        {
            ...
            //note: accessing navigation property here
